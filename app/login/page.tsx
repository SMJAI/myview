    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-brand-600">MyView</h1>
          <p className="text-gray-500 mt-1 text-sm">Physio Healing Hands</p>
        </div>

        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Sign in</h2>
          <p className="text-sm text-gray-500 mb-6">
            Use your Physio Healing Hands Google Workspace account.
          </p>
